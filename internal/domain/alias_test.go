...
func (m *mockAliasRepo) Find(params domain.FindAliasParameters) (domain.Alias, error) {
...
func TestGetAlias(t *testing.T) {
	...
	alias, err := svc.Find(domain.FindAliasParameters{User: ptr.To("bob"), Domain: ptr.To("sample.com")})
	...
	alias, err = svc.Find(domain.FindAliasParameters{User: ptr.To("test"), Domain: ptr.To("test.com")})
